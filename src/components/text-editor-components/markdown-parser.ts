/// add notes license notes for prosemirror-markdown
...
const md = MarkdownIt("commonmark", {html: false}).use(require("markdown-it-wikilinks")({baseURL: "", relativeBaseURL: "", htmlAttributes: {
  "class": "internal-link",
  "rel": "nofollow",
}}))
